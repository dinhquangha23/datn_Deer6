...
function CartProduct() {
  ...
  let [flagRerenderWhenUpdateQuantity, setFlagRerenderWhenUpdateQuantity] =
    useState(true);
  ...
  useEffect(() => {
    ...
    Axios.get(`cart/${idUser}`).then((res) => {
      console.log("giỏ hàng của", idUser, "là", res.data?.data);
      setData(res.data?.data);
      setEstimate(calculateEstimate(res.data?.data, 0));
    });
        ...
        <div className="bill">
                  ...
                  return (
                    item && (
                      <CartItem
                        ...
                        cartData={item}
                        setFlagRerenderWhenUpdateQuantity={
                          setFlagRerenderWhenUpdateQuantity
                        }
                      />
                    )
          ...
          <div className="total_money_cart">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="total_money">
                    <span style={{ fontSize: 15 }}>
                      {data ? fomartMoney(estimate + 30000) : 0}
                    </span>{" "}
                    ₫
                  </td>
                </tr>
            ...
            <div className="check_out">
              <button className="btn_check_out" onClick={handlePay}>
